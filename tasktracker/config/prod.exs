...
config :tasktracker, TasktrackerWeb.Endpoint,
  ...
  url: [host: "tasks1.pontiac.fun", port: 80],
...
#
#     config :shooting_gallery, ShootingGalleryWeb.Endpoint,
#       ...
...
# start per endpoint:
#
#     config :shooting_gallery, ShootingGalleryWeb.Endpoint, server: true
#
...
config :tasktracker, TasktrackerWeb.Endpoint, secret_key_base: get_secret.("key_base")
